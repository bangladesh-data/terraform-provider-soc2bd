...
func TestAccDatasourceSoc2bdUsers_basic(t *testing.T) {
	t.Run("Test Soc2bd Datasource : Acc Users Basic", func(t *testing.T) {
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: testDatasourceSoc2bdUsers(),
					Check: acctests.ComposeTestCheckFunc(
						testCheckResourceAttrNotEqual("data.soc2bd_users.all", attr.Len(attr.Users), "0"),
					),
				},
			},
		})
...
func testDatasourceSoc2bdUsers() string {
	return `
