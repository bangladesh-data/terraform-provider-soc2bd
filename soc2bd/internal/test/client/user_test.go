...
func TestClientUserReadOk(t *testing.T) {
	...
	for _, td := range testData {
		t.Run("Test Soc2bd Resource : Read User Ok - "+td.role, func(t *testing.T) {
			const (
				userID = "id"
				email  = "user@email"
			)
...
func TestClientUserReadError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read User Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "user": null
		  }
...
func TestClientUserReadRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read User Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
...
func TestClientReadEmptyUserError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Empty User Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "user": null
		  }
...
func TestClientUserCreateOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Create User Ok", func(t *testing.T) {
		input := &model.User{
...
func TestClientUserCreateErrorEmptyEmail(t *testing.T) {
	t.Run("Test Soc2bd Resource : Create User - Error Empty Email", func(t *testing.T) {
		input := &model.User{
			Role: "MEMBER",
		}
...
func TestClientUserCreateRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Create User - Request Error", func(t *testing.T) {
		input := &model.User{
			Email: "some@email.com",
			Role:  "MEMBER",
		}
...
func TestClientUserUpdateOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update User Ok", func(t *testing.T) {
...
func TestClientUserUpdateWithRoleOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update User With Role Ok", func(t *testing.T) {
		input := &model.UserUpdate{
			ID:        "user-id",
			FirstName: optionalString("New name"),
...
func TestClientUserUpdateOnlyRoleOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update User Only Role Ok", func(t *testing.T) {
		input := &model.UserUpdate{
			ID:   "user-id",
			Role: optionalString("SUPPORT"),
		}
...
func TestClientUserNoUpdatesOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : No User Updates Ok", func(t *testing.T) {
		input := &model.UserUpdate{
			ID: "user-id",
		}
...
func TestClientUserUpdateErrorEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update User - Error Empty ID", func(t *testing.T) {
		client := newHTTPMockClient()
...
func TestClientUserUpdateRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update User - Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientUserUpdateWithEmptyRoleRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update User With Empty Role - Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientUserUpdateRoleRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update User Role - Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientUserUpdateRoleErrorEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update User Role - Error Empty ID", func(t *testing.T) {
		client := newHTTPMockClient()
...
func TestClientUserDeleteErrorEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete User - Error Empty ID", func(t *testing.T) {
		client := newHTTPMockClient()
...
func TestClientUserDeleteRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete User - Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientUserDeleteOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete User Ok", func(t *testing.T) {
		response := `{
          "data": {
            "userDelete": {
              "ok": true,
...
func TestClientUserDeleteResponseError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete User Response Error", func(t *testing.T) {
		response := `{
          "data": {
            "userDelete": {
              "ok": false,
