...
func TestClientSecurityPolicyReadOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Security Policy Read - Ok", func(t *testing.T) {
...
func TestClientSecurityPolicyReadByNameOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Security Policy Read By Name - Ok", func(t *testing.T) {
		expected := &model.SecurityPolicy{
			ID:   "id",
			Name: "name",
		}
...
func TestClientSecurityPolicyReadWithEmptyNameAndID(t *testing.T) {
	t.Run("Test Soc2bd Resource : Security Policy Read With Empty Name And ID", func(t *testing.T) {
		c := newHTTPMockClient()
...
func TestClientSecurityPolicyReadRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Security Policy - Request Error", func(t *testing.T) {
		c := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", c.GraphqlServerURL,
...
func TestClientSecurityPolicyReadEmptyResponse(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Security Policy - Empty Response", func(t *testing.T) {
		response1 := `{
		  "data": {
		    "securityPolicy": null
		  }
...
func TestClientSecurityPoliciesReadOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Security Policies Read - Ok", func(t *testing.T) {
		expected := []*model.SecurityPolicy{
			{
				ID:   "policy-1",
				Name: "name-1",
...
func TestClientSecurityPoliciesReadRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Security Policies - Request Error", func(t *testing.T) {
		c := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", c.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientSecurityPoliciesReadEmptyResponse(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Security Policies - Empty Response", func(t *testing.T) {
		response1 := `{
		  "data": {
		    "securityPolicies": {
		      "pageInfo": {
...
func TestClientSecurityPoliciesReadRequestErrorOnFetching(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Security Policies - Request Error On Fetching", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "securityPolicies": {
		      "pageInfo": {
...
func TestClientSecurityPoliciesReadEmptyResultOnFetching(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Security Policies - Empty Result on Fetching", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "securityPolicies": {
		      "pageInfo": {
