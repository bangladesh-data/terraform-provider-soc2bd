...
func TestCreateServiceKeyOk(t *testing.T) {
	t.Run("Test Soc2bd Resource: Create Service Key - Ok", func(t *testing.T) {
...
func TestCreateServiceKeyWithNameOk(t *testing.T) {
	t.Run("Test Soc2bd Resource: Create Service Key With Name - Ok", func(t *testing.T) {
		expected := &model.ServiceKey{
			ID:      "key-id",
			Name:    "new name",
...
func TestCreateServiceKeyRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource: Create Service Key - Request Error", func(t *testing.T) {
		c := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", c.GraphqlServerURL,
...
func TestCreateServiceKeyResponseError(t *testing.T) {
	t.Run("Test Soc2bd Resource: Create Service Key - Response Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "serviceAccountKeyCreate": {
		      "ok": false,
...
func TestCreateServiceKeyWithEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource: Create Service Key - With Empty ID", func(t *testing.T) {
		c := newHTTPMockClient()
...
func TestCreateServiceKeyWithNilRequest(t *testing.T) {
	t.Run("Test Soc2bd Resource: Create Service Key - With Nil Request", func(t *testing.T) {
		c := newHTTPMockClient()
...
func TestReadServiceKeyOk(t *testing.T) {
	t.Run("Test Soc2bd Resource: Read Service Key - Ok", func(t *testing.T) {
		expected := &model.ServiceKey{
			ID:      "key-id",
			Name:    "name",
			Service: "service-account-id",
...
func TestReadServiceKeyWithEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource: Read Service Key - With Empty ID", func(t *testing.T) {
		c := newHTTPMockClient()
...
func TestReadServiceKeyRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource: Read Service Key - Request Error", func(t *testing.T) {
		c := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", c.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestReadServiceKeyEmptyResponse(t *testing.T) {
	t.Run("Test Soc2bd Resource: Read Service Key - Empty Response", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
...
func TestUpdateServiceKeyOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Service Key - Ok", func(t *testing.T) {
		expected := &model.ServiceKey{
			ID:      "key-id",
			Name:    "new name",
			Service: "service-account-id",
...
func TestUpdateServiceKeyWithEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Service Key - With Empty ID", func(t *testing.T) {
		c := newHTTPMockClient()
...
func TestUpdateServiceKeyRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Service Key - Request Error", func(t *testing.T) {
		c := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", c.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestUpdateServiceKeyResponseError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Service Key - Response Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "serviceAccountKeyUpdate": {
		      "entity": null,
...
func TestUpdateServiceKeyEmptyResponse(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Service Key - Empty Response", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "serviceAccountKeyUpdate": {
		      "entity": null,
...
func TestDeleteServiceKeyOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete Service Key - Ok", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
...
func TestDeleteServiceKeyWithEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete Service Key - With Empty ID", func(t *testing.T) {
		c := newHTTPMockClient()
...
func TestDeleteServiceKeyRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete Service Key - Request Error", func(t *testing.T) {
		c := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", c.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestDeleteServiceKeyResponseError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete Service Key - Response Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "serviceAccountKeyDelete": {
		      "ok": false,
...
func TestRevokeServiceKeyOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Revoke Service Key - Ok", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
...
func TestRevokeServiceKeyWithEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource : Revoke Service Key - With Empty ID", func(t *testing.T) {
		c := newHTTPMockClient()
...
func TestRevokeServiceKeyRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Revoke Service Key - Request Error", func(t *testing.T) {
		c := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", c.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestRevokeServiceKeyResponseError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Revoke Service Key - Response Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "serviceAccountKeyRevoke": {
		      "ok": false,
