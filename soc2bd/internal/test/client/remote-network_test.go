...
func TestClientRemoteNetworkCreateOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Create Remote Network Ok", func(t *testing.T) {
...
func TestClientRemoteNetworkCreateError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Create Remote Network Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetworkCreate": {
		      "ok": false,
...
func TestClientRemoteNetworkCreateRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Create Remote Network Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
...
func TestClientRemoteNetworkCreateEmptyResponse(t *testing.T) {
	t.Run("Test Soc2bd Resource : Create Remote Network - Empty Response", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetworkCreate": {
		      "ok": true,
...
func TestClientRemoteNetworkUpdateError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Remote Network Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetworkUpdate": {
		      "ok": false,
...
func TestClientRemoteNetworkUpdateEmptyResponse(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Remote Network - Empty Response", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetworkUpdate": {
		      "ok": true,
...
func TestClientRemoteNetworkUpdateOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Remote Network - Ok", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetworkUpdate": {
		      "ok": true,
...
func TestClientRemoteNetworkUpdateRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Update Remote Network Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientRemoteNetworkReadByIDError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Remote Network Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetwork": null
		  }
...
func TestClientRemoteNetworkReadByIDRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Remote Network Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientCreateEmptyRemoteNetworkError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Create Empty Remote Network Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetwork": null
		  }
...
func TestClientReadEmptyRemoteNetworkByIDError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Empty Remote Network Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetwork": null
		  }
...
func TestClientDeleteRemoteNetworkWithEmptyID(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete Remote Network - With Empty ID", func(t *testing.T) {
		jsonResponse := `{}`
...
func TestClientDeleteRemoteNetworkRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete Remote Network - Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientDeleteRemoteNetworkError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete Remote Network - Error", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetworkDelete": {
		      "ok": false,
...
func TestClientDeleteRemoteNetworkOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Delete Remote Network - Ok", func(t *testing.T) {
		jsonResponse := `{
		  "data": {
		    "remoteNetworkDelete": {
		      "ok": true
...
func TestClientNetworkReadAllOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read All Remote Networks", func(t *testing.T) {
		expected := []*model.RemoteNetwork{
			{
				ID:       "network1",
...
func TestClientNetworkReadAllRequestError(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read All Remote Networks - Request Error", func(t *testing.T) {
		client := newHTTPMockClient()
		defer httpmock.DeactivateAndReset()
		httpmock.RegisterResponder("POST", client.GraphqlServerURL,
			httpmock.NewErrorResponder(errBadRequest))
...
func TestClientNetworkReadAllEmptyResponse(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read All Remote Networks - Empty Response", func(t *testing.T) {
		response1 := `{
		  "data": {
		    "remoteNetworks": {
		      "pageInfo": {
...
func TestClientReadRemoteNetworkWithIDOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Remote Network With ID - Ok", func(t *testing.T) {
		expected := &model.RemoteNetwork{
			ID:       "network1",
			Name:     "tf-acc-network1",
			Location: model.LocationOther,
...
func TestClientReadRemoteNetworkWithNameOk(t *testing.T) {
	t.Run("Test Soc2bd Resource : Read Remote Network With Name - Ok", func(t *testing.T) {
		expected := &model.RemoteNetwork{
			ID:       "network1",
			Name:     "tf-acc-network1",
			Location: model.LocationAWS,
